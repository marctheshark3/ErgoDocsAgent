# Bounties - ErgoDocs
Source: [https://docs.ergoplatform.com/contribute/bounties/](https://docs.ergoplatform.com/contribute/bounties/)
Generated: 2025-05-11

## Summary
Welcome to the Ergo Bounties page! This is your gateway to contributing to the Ergo community and being rewarded for your valuable efforts. We offer a variety of bounties across different programs, including educational and development initiatives, all aimed at fostering growth and innovation within the Ergo ecosystem. Have you completed a task or achieved a goal that aligns with our bounties? If so, you are eligible to claim your reward.

## Keywords
ergo, bounties, page, gateway, community, effort, variety, bounty, program, development, initiative, growth, innovation, ecosystem, task, goal, reward, processing, claim, time
...
Draft an email to team@ergoplatform.org detailing your claim.
Make sure to include all relevant details in your email, such as the platform where the bounty was announced or a reference to this page for the mentioned bounties.
Attach evidence of your completed work. This could be documents, files, or links that showcase your contributions.
Remember to include your Ergo address. This is where we will send your bounty reward.
