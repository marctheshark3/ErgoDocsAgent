# Just-In-Time Costing - ErgoDocs
Source: [https://docs.ergoplatform.com/node/jitc/](https://docs.ergoplatform.com/node/jitc/)
...
## Keywords
discussion, transaction, efficiency, scalability, costing, cryptocurrency, space, technology, term, viability, adoption, adaptability, ergo, protocol, reference, client, 5.0.0, advancement, benefit, miner
