# Why Ergo?
Source: docs/dev/protocol/why.md
...
## Keywords
ergo, overview, generation, contract, platform, freedom, people, tool, scripting, language, feature, foundation, principle, technology, concept, contractual, money, vision, fusion, research
...
Ergo leverages Sigma Protocols (Σ-Protocols) to power its smart contracts, enabling the use of efficient zero-knowledge proofs. This allows for the performance of complex, privacy-sensitive tasks without intermediaries, fostering a trustless environment with unparalleled application-level privacy.
