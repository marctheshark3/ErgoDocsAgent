# Log-Space Mining
Source: docs/dev/protocol/nipopow/logspace.md
...
## Keywords
mining, space, overview, concept, approach, datum, miner, node, blockchain, ecosystem, proofs, proof, work, nipopows, superblock, storage, requirement, interoperability, network, operation
...
### Resources
NIPoPoWs & Log-Space Mining – Ergo Cast Episode #5: A comprehensive overview of Non-Interactive Proofs of Proof-of-Work and Log-Space Mining by Dionysis Zindros.
