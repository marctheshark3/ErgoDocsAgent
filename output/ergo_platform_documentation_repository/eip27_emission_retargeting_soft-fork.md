...
Source: docs/mining/standards/eip27.md
...
Ergo currently mines blocks every two minutes.

## Keywords
eip27, emission, soft, fork, ergo, tokenomics, proof, work, blockchain, schedule, release, tokens, coin, offering, allocation, token, founder, venture, capitalist, mainnet
...
These new emission rules will be integrated with the original emission schedule of the Whitepaper. Currently, block rewards are reduced every three months by 3 ERG/block - this will still be the case after EIP27 is activated. However, once implemented (approximately June 21), the block size will be 51 ERG/block. Based on the original emission sc...
